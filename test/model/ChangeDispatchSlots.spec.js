...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChangeDispatchSlots', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ChangeDispatchSlots();
      });

      it('should create an instance of ChangeDispatchSlots', function() {
        // TODO: update the code to test ChangeDispatchSlots
        expect(instance).to.be.a(FlipkartMarketplaceApi.ChangeDispatchSlots);
      });
