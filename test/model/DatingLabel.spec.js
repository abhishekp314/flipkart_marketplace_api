...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DatingLabel', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.DatingLabel();
      });

      it('should create an instance of DatingLabel', function() {
        // TODO: update the code to test DatingLabel
        expect(instance).to.be.a(FlipkartMarketplaceApi.DatingLabel);
      });

      it('should have the property mfgDate (base name: "mfg_date")', function() {
        // TODO: update the code to test the property mfgDate
        expect(instance).to.have.property('mfgDate');
        // expect(instance.mfgDate).to.be(expectedValueLiteral);
      });

      it('should have the property shelfLife (base name: "shelf_life")', function() {
        // TODO: update the code to test the property shelfLife
        expect(instance).to.have.property('shelfLife');
        // expect(instance.shelfLife).to.be(expectedValueLiteral);
      });
