...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentsDispatchRequestV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ShipmentsDispatchRequestV2();
      });

      it('should create an instance of ShipmentsDispatchRequestV2', function() {
        // TODO: update the code to test ShipmentsDispatchRequestV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.ShipmentsDispatchRequestV2);
      });
