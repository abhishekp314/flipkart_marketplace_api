...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GenerateLabelRequestItemV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.GenerateLabelRequestItemV2();
      });

      it('should create an instance of GenerateLabelRequestItemV2', function() {
        // TODO: update the code to test GenerateLabelRequestItemV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.GenerateLabelRequestItemV2);
      });
      ...
      it('should have the property subItems (base name: "subItems")', function() {
        // TODO: update the code to test the property subItems
        expect(instance).to.have.property('subItems');
        // expect(instance.subItems).to.be(expectedValueLiteral);
      });
