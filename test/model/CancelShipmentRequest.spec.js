...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CancelShipmentRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CancelShipmentRequest();
      });

      it('should create an instance of CancelShipmentRequest', function() {
        // TODO: update the code to test CancelShipmentRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.CancelShipmentRequest);
      });
