...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoicesSearchResponseV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.InvoicesSearchResponseV2();
      });

      it('should create an instance of InvoicesSearchResponseV2', function() {
        // TODO: update the code to test InvoicesSearchResponseV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.InvoicesSearchResponseV2);
      });
