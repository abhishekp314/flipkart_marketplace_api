...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderItemCancelResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.OrderItemCancelResponse();
      });

      it('should create an instance of OrderItemCancelResponse', function() {
        // TODO: update the code to test OrderItemCancelResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.OrderItemCancelResponse);
      });
      ...
      it('should have the property failedCancellations (base name: "failedCancellations")', function() {
        // TODO: update the code to test the property failedCancellations
        expect(instance).to.have.property('failedCancellations');
        // expect(instance.failedCancellations).to.be(expectedValueLiteral);
      });
