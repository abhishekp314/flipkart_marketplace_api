...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentPackRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ShipmentPackRequest();
      });

      it('should create an instance of ShipmentPackRequest', function() {
        // TODO: update the code to test ShipmentPackRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.ShipmentPackRequest);
      });
