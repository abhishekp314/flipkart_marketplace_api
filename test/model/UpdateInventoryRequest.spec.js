...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateInventoryRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.UpdateInventoryRequest();
      });

      it('should create an instance of UpdateInventoryRequest', function() {
        // TODO: update the code to test UpdateInventoryRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.UpdateInventoryRequest);
      });
