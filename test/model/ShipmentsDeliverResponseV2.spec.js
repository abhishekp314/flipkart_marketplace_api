...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentsDeliverResponseV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ShipmentsDeliverResponseV2();
      });

      it('should create an instance of ShipmentsDeliverResponseV2', function() {
        // TODO: update the code to test ShipmentsDeliverResponseV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.ShipmentsDeliverResponseV2);
      });
