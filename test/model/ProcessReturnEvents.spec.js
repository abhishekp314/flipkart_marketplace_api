...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProcessReturnEvents', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ProcessReturnEvents();
      });

      it('should create an instance of ProcessReturnEvents', function() {
        // TODO: update the code to test ProcessReturnEvents
        expect(instance).to.be.a(FlipkartMarketplaceApi.ProcessReturnEvents);
      });
