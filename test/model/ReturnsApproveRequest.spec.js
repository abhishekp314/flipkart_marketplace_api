...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReturnsApproveRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ReturnsApproveRequest();
      });

      it('should create an instance of ReturnsApproveRequest', function() {
        // TODO: update the code to test ReturnsApproveRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.ReturnsApproveRequest);
      });
