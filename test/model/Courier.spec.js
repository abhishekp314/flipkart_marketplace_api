...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Courier', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.Courier();
      });

      it('should create an instance of Courier', function() {
        // TODO: update the code to test Courier
        expect(instance).to.be.a(FlipkartMarketplaceApi.Courier);
      });

      it('should have the property pickupDetails (base name: "pickupDetails")', function() {
        // TODO: update the code to test the property pickupDetails
        expect(instance).to.have.property('pickupDetails');
        // expect(instance.pickupDetails).to.be(expectedValueLiteral);
      });

      it('should have the property deliveryDetails (base name: "deliveryDetails")', function() {
        // TODO: update the code to test the property deliveryDetails
        expect(instance).to.have.property('deliveryDetails');
        // expect(instance.deliveryDetails).to.be(expectedValueLiteral);
      });
