...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MakeOrderUnHold', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.MakeOrderUnHold();
      });

      it('should create an instance of MakeOrderUnHold', function() {
        // TODO: update the code to test MakeOrderUnHold
        expect(instance).to.be.a(FlipkartMarketplaceApi.MakeOrderUnHold);
      });
