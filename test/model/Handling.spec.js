...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Handling', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.Handling();
      });

      it('should create an instance of Handling', function() {
        // TODO: update the code to test Handling
        expect(instance).to.be.a(FlipkartMarketplaceApi.Handling);
      });

      it('should have the property fragile (base name: "fragile")', function() {
        // TODO: update the code to test the property fragile
        expect(instance).to.have.property('fragile');
        // expect(instance.fragile).to.be(expectedValueLiteral);
      });
