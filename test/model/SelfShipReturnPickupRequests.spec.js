...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SelfShipReturnPickupRequests', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SelfShipReturnPickupRequests();
      });

      it('should create an instance of SelfShipReturnPickupRequests', function() {
        // TODO: update the code to test SelfShipReturnPickupRequests
        expect(instance).to.be.a(FlipkartMarketplaceApi.SelfShipReturnPickupRequests);
      });
