...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentSearchResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ShipmentSearchResponse();
      });

      it('should create an instance of ShipmentSearchResponse', function() {
        // TODO: update the code to test ShipmentSearchResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.ShipmentSearchResponse);
      });
