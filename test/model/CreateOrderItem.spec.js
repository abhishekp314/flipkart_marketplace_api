...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateOrderItem', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CreateOrderItem();
      });

      it('should create an instance of CreateOrderItem', function() {
        // TODO: update the code to test CreateOrderItem
        expect(instance).to.be.a(FlipkartMarketplaceApi.CreateOrderItem);
      });
      ...
      it('should have the property subItem (base name: "subItem")', function() {
        // TODO: update the code to test the property subItem
        expect(instance).to.have.property('subItem');
        // expect(instance.subItem).to.be(expectedValueLiteral);
      });
