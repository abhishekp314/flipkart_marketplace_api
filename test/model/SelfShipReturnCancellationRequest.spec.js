...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SelfShipReturnCancellationRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SelfShipReturnCancellationRequest();
      });

      it('should create an instance of SelfShipReturnCancellationRequest', function() {
        // TODO: update the code to test SelfShipReturnCancellationRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.SelfShipReturnCancellationRequest);
      });
