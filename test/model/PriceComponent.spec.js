...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PriceComponent', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.PriceComponent();
      });

      it('should create an instance of PriceComponent', function() {
        // TODO: update the code to test PriceComponent
        expect(instance).to.be.a(FlipkartMarketplaceApi.PriceComponent);
      });
