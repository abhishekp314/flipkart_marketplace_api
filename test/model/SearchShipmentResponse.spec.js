...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SearchShipmentResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SearchShipmentResponse();
      });

      it('should create an instance of SearchShipmentResponse', function() {
        // TODO: update the code to test SearchShipmentResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.SearchShipmentResponse);
      });
