...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CancelShipment', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CancelShipment();
      });

      it('should create an instance of CancelShipment', function() {
        // TODO: update the code to test CancelShipment
        expect(instance).to.be.a(FlipkartMarketplaceApi.CancelShipment);
      });
      ...
      it('should have the property cancellationGroupIds (base name: "cancellationGroupIds")', function() {
        // TODO: update the code to test the property cancellationGroupIds
        expect(instance).to.have.property('cancellationGroupIds');
        // expect(instance.cancellationGroupIds).to.be(expectedValueLiteral);
      });
