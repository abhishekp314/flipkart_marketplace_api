...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateCourierReturnResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CreateCourierReturnResponse();
      });

      it('should create an instance of CreateCourierReturnResponse', function() {
        // TODO: update the code to test CreateCourierReturnResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.CreateCourierReturnResponse);
      });
