...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SellerAddress', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SellerAddress();
      });

      it('should create an instance of SellerAddress', function() {
        // TODO: update the code to test SellerAddress
        expect(instance).to.be.a(FlipkartMarketplaceApi.SellerAddress);
      });
