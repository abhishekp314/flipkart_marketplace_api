...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SelfshipDispatchRequestV3', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SelfshipDispatchRequestV3();
      });

      it('should create an instance of SelfshipDispatchRequestV3', function() {
        // TODO: update the code to test SelfshipDispatchRequestV3
        expect(instance).to.be.a(FlipkartMarketplaceApi.SelfshipDispatchRequestV3);
      });
