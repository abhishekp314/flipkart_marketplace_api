...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentsDeliverRequestV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ShipmentsDeliverRequestV2();
      });

      it('should create an instance of ShipmentsDeliverRequestV2', function() {
        // TODO: update the code to test ShipmentsDeliverRequestV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.ShipmentsDeliverRequestV2);
      });
