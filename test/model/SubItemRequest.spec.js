...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubItemRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SubItemRequest();
      });

      it('should create an instance of SubItemRequest', function() {
        // TODO: update the code to test SubItemRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.SubItemRequest);
      });
