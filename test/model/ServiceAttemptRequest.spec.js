...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceAttemptRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ServiceAttemptRequest();
      });

      it('should create an instance of ServiceAttemptRequest', function() {
        // TODO: update the code to test ServiceAttemptRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.ServiceAttemptRequest);
      });
