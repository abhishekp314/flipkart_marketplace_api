...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NotionalValue', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.NotionalValue();
      });

      it('should create an instance of NotionalValue', function() {
        // TODO: update the code to test NotionalValue
        expect(instance).to.be.a(FlipkartMarketplaceApi.NotionalValue);
      });
