...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubShipments', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SubShipments();
      });

      it('should create an instance of SubShipments', function() {
        // TODO: update the code to test SubShipments
        expect(instance).to.be.a(FlipkartMarketplaceApi.SubShipments);
      });

      it('should have the property subShipmentId (base name: "subShipmentId")', function() {
        // TODO: update the code to test the property subShipmentId
        expect(instance).to.have.property('subShipmentId');
        // expect(instance.subShipmentId).to.be(expectedValueLiteral);
      });
