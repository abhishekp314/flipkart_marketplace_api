...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentsDispatchResponseV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ShipmentsDispatchResponseV2();
      });

      it('should create an instance of ShipmentsDispatchResponseV2', function() {
        // TODO: update the code to test ShipmentsDispatchResponseV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.ShipmentsDispatchResponseV2);
      });
