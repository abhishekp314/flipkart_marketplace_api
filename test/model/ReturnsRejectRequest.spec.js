...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReturnsRejectRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ReturnsRejectRequest();
      });

      it('should create an instance of ReturnsRejectRequest', function() {
        // TODO: update the code to test ReturnsRejectRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.ReturnsRejectRequest);
      });
