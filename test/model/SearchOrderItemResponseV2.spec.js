...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SearchOrderItemResponseV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SearchOrderItemResponseV2();
      });

      it('should create an instance of SearchOrderItemResponseV2', function() {
        // TODO: update the code to test SearchOrderItemResponseV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.SearchOrderItemResponseV2);
      });
      ...
      it('should have the property nextPageUrl (base name: "nextPageUrl")', function() {
      ...
      it('should have the property previousPageUrl (base name: "previousPageUrl")', function() {
        // TODO: update the code to test the property previousPageUrl
        expect(instance).to.have.property('previousPageUrl');
        // expect(instance.previousPageUrl).to.be(expectedValueLiteral);
      });
