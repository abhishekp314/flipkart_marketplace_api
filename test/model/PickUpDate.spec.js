...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PickUpDate', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.PickUpDate();
      });

      it('should create an instance of PickUpDate', function() {
        // TODO: update the code to test PickUpDate
        expect(instance).to.be.a(FlipkartMarketplaceApi.PickUpDate);
      });
