...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SerialNumber', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SerialNumber();
      });

      it('should create an instance of SerialNumber', function() {
        // TODO: update the code to test SerialNumber
        expect(instance).to.be.a(FlipkartMarketplaceApi.SerialNumber);
      });
