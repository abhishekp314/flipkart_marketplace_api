...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Otc', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.Otc();
      });

      it('should create an instance of Otc', function() {
        // TODO: update the code to test Otc
        expect(instance).to.be.a(FlipkartMarketplaceApi.Otc);
      });
