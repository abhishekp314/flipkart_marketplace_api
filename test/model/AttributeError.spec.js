...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AttributeError', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.AttributeError();
      });

      it('should create an instance of AttributeError', function() {
        // TODO: update the code to test AttributeError
        expect(instance).to.be.a(FlipkartMarketplaceApi.AttributeError);
      });
