...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateTestOrdersResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CreateTestOrdersResponse();
      });

      it('should create an instance of CreateTestOrdersResponse', function() {
        // TODO: update the code to test CreateTestOrdersResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.CreateTestOrdersResponse);
      });
