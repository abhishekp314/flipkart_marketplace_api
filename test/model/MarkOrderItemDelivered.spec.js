...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarkOrderItemDelivered', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.MarkOrderItemDelivered();
      });

      it('should create an instance of MarkOrderItemDelivered', function() {
        // TODO: update the code to test MarkOrderItemDelivered
        expect(instance).to.be.a(FlipkartMarketplaceApi.MarkOrderItemDelivered);
      });
