...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentDetailsResponseV3', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ShipmentDetailsResponseV3();
      });

      it('should create an instance of ShipmentDetailsResponseV3', function() {
        // TODO: update the code to test ShipmentDetailsResponseV3
        expect(instance).to.be.a(FlipkartMarketplaceApi.ShipmentDetailsResponseV3);
      });
