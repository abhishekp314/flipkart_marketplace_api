...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceCompleteRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ServiceCompleteRequest();
      });

      it('should create an instance of ServiceCompleteRequest', function() {
        // TODO: update the code to test ServiceCompleteRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.ServiceCompleteRequest);
      });
