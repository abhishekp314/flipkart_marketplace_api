...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubItemResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SubItemResponse();
      });

      it('should create an instance of SubItemResponse', function() {
        // TODO: update the code to test SubItemResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.SubItemResponse);
      });
