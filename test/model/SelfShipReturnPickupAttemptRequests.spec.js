...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SelfShipReturnPickupAttemptRequests', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SelfShipReturnPickupAttemptRequests();
      });

      it('should create an instance of SelfShipReturnPickupAttemptRequests', function() {
        // TODO: update the code to test SelfShipReturnPickupAttemptRequests
        expect(instance).to.be.a(FlipkartMarketplaceApi.SelfShipReturnPickupAttemptRequests);
      });
