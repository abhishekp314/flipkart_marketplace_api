...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateService', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CreateService();
      });

      it('should create an instance of CreateService', function() {
        // TODO: update the code to test CreateService
        expect(instance).to.be.a(FlipkartMarketplaceApi.CreateService);
      });
