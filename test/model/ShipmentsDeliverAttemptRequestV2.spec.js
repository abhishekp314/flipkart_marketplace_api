...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentsDeliverAttemptRequestV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ShipmentsDeliverAttemptRequestV2();
      });

      it('should create an instance of ShipmentsDeliverAttemptRequestV2', function() {
        // TODO: update the code to test ShipmentsDeliverAttemptRequestV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.ShipmentsDeliverAttemptRequestV2);
      });
