...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BuyerDetails', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.BuyerDetails();
      });

      it('should create an instance of BuyerDetails', function() {
        // TODO: update the code to test BuyerDetails
        expect(instance).to.be.a(FlipkartMarketplaceApi.BuyerDetails);
      });
