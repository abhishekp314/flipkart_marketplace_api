...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateCourierReturnRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CreateCourierReturnRequest();
      });

      it('should create an instance of CreateCourierReturnRequest', function() {
        // TODO: update the code to test CreateCourierReturnRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.CreateCourierReturnRequest);
      });
      ...
      it('should have the property returnType (base name: "returnType")', function() {
        // TODO: update the code to test the property returnType
        expect(instance).to.have.property('returnType');
        // expect(instance.returnType).to.be(expectedValueLiteral);
      });
