...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CancelRequestV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CancelRequestV2();
      });

      it('should create an instance of CancelRequestV2', function() {
        // TODO: update the code to test CancelRequestV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.CancelRequestV2);
      });
