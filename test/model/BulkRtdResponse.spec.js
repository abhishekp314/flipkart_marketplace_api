...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BulkRtdResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.BulkRtdResponse();
      });

      it('should create an instance of BulkRtdResponse', function() {
        // TODO: update the code to test BulkRtdResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.BulkRtdResponse);
      });
