...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentResponseStatusV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ShipmentResponseStatusV2();
      });

      it('should create an instance of ShipmentResponseStatusV2', function() {
        // TODO: update the code to test ShipmentResponseStatusV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.ShipmentResponseStatusV2);
      });
