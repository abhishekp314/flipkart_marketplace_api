...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SelfShipReturnPickupRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SelfShipReturnPickupRequest();
      });

      it('should create an instance of SelfShipReturnPickupRequest', function() {
        // TODO: update the code to test SelfShipReturnPickupRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.SelfShipReturnPickupRequest);
      });
