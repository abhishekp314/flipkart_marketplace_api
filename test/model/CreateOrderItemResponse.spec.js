...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateOrderItemResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CreateOrderItemResponse();
      });

      it('should create an instance of CreateOrderItemResponse', function() {
        // TODO: update the code to test CreateOrderItemResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.CreateOrderItemResponse);
      });
