...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CancelOrderItemRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CancelOrderItemRequest();
      });

      it('should create an instance of CancelOrderItemRequest', function() {
        // TODO: update the code to test CancelOrderItemRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.CancelOrderItemRequest);
      });
