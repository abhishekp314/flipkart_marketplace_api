...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubShipment', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SubShipment();
      });

      it('should create an instance of SubShipment', function() {
        // TODO: update the code to test SubShipment
        expect(instance).to.be.a(FlipkartMarketplaceApi.SubShipment);
      });
