...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfirmItemRow', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ConfirmItemRow();
      });

      it('should create an instance of ConfirmItemRow', function() {
        // TODO: update the code to test ConfirmItemRow
        expect(instance).to.be.a(FlipkartMarketplaceApi.ConfirmItemRow);
      });
