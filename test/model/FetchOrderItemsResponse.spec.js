...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FetchOrderItemsResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.FetchOrderItemsResponse();
      });

      it('should create an instance of FetchOrderItemsResponse', function() {
        // TODO: update the code to test FetchOrderItemsResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.FetchOrderItemsResponse);
      });
