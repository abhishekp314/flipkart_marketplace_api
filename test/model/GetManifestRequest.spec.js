...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetManifestRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.GetManifestRequest();
      });

      it('should create an instance of GetManifestRequest', function() {
        // TODO: update the code to test GetManifestRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.GetManifestRequest);
      });
