...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BulkOrderItem', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.BulkOrderItem();
      });

      it('should create an instance of BulkOrderItem', function() {
        // TODO: update the code to test BulkOrderItem
        expect(instance).to.be.a(FlipkartMarketplaceApi.BulkOrderItem);
      });
