...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FailedCancellations', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.FailedCancellations();
      });

      it('should create an instance of FailedCancellations', function() {
        // TODO: update the code to test FailedCancellations
        expect(instance).to.be.a(FlipkartMarketplaceApi.FailedCancellations);
      });
