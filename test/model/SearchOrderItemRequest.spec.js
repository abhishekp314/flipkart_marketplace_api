...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SearchOrderItemRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.SearchOrderItemRequest();
      });

      it('should create an instance of SearchOrderItemRequest', function() {
        // TODO: update the code to test SearchOrderItemRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.SearchOrderItemRequest);
      });
