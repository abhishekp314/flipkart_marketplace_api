...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeliverRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.DeliverRequest();
      });

      it('should create an instance of DeliverRequest', function() {
        // TODO: update the code to test DeliverRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.DeliverRequest);
      });
