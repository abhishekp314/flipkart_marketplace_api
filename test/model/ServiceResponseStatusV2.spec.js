...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceResponseStatusV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ServiceResponseStatusV2();
      });

      it('should create an instance of ServiceResponseStatusV2', function() {
        // TODO: update the code to test ServiceResponseStatusV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.ServiceResponseStatusV2);
      });
