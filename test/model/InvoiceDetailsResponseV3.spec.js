...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceDetailsResponseV3', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.InvoiceDetailsResponseV3();
      });

      it('should create an instance of InvoiceDetailsResponseV3', function() {
        // TODO: update the code to test InvoiceDetailsResponseV3
        expect(instance).to.be.a(FlipkartMarketplaceApi.InvoiceDetailsResponseV3);
      });
