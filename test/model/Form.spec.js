...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Form', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.Form();
      });

      it('should create an instance of Form', function() {
        // TODO: update the code to test Form
        expect(instance).to.be.a(FlipkartMarketplaceApi.Form);
      });
      ...
      it('should have the property automated (base name: "automated")', function() {
        // TODO: update the code to test the property automated
        expect(instance).to.have.property('automated');
        // expect(instance.automated).to.be(expectedValueLiteral);
      });
