...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BulkConfirmedItem', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.BulkConfirmedItem();
      });

      it('should create an instance of BulkConfirmedItem', function() {
        // TODO: update the code to test BulkConfirmedItem
        expect(instance).to.be.a(FlipkartMarketplaceApi.BulkConfirmedItem);
      });
