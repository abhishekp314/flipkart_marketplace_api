...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BulkConfirmItem', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.BulkConfirmItem();
      });

      it('should create an instance of BulkConfirmItem', function() {
        // TODO: update the code to test BulkConfirmItem
        expect(instance).to.be.a(FlipkartMarketplaceApi.BulkConfirmItem);
      });
