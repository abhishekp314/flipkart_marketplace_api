...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DispatchShipmentRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.DispatchShipmentRequest();
      });

      it('should create an instance of DispatchShipmentRequest', function() {
        // TODO: update the code to test DispatchShipmentRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.DispatchShipmentRequest);
      });
