...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarkOrderItemPickupComplete', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.MarkOrderItemPickupComplete();
      });

      it('should create an instance of MarkOrderItemPickupComplete', function() {
        // TODO: update the code to test MarkOrderItemPickupComplete
        expect(instance).to.be.a(FlipkartMarketplaceApi.MarkOrderItemPickupComplete);
      });
