...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateShipmentRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.UpdateShipmentRequest();
      });

      it('should create an instance of UpdateShipmentRequest', function() {
        // TODO: update the code to test UpdateShipmentRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.UpdateShipmentRequest);
      });
      ...
      it('should have the property deliveryPartner (base name: "delivery_partner")', function() {
      ...
      it('should have the property tentativeDeliveryDate (base name: "tentative_delivery_date")', function() {
