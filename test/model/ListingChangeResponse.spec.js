...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListingChangeResponse', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ListingChangeResponse();
      });

      it('should create an instance of ListingChangeResponse', function() {
        // TODO: update the code to test ListingChangeResponse
        expect(instance).to.be.a(FlipkartMarketplaceApi.ListingChangeResponse);
      });
      ...
      it('should have the property attributeErrors (base name: "attribute_errors")', function() {
        // TODO: update the code to test the property attributeErrors
        expect(instance).to.have.property('attributeErrors');
        // expect(instance.attributeErrors).to.be(expectedValueLiteral);
      });
