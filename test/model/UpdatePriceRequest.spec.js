...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdatePriceRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.UpdatePriceRequest();
      });

      it('should create an instance of UpdatePriceRequest', function() {
        // TODO: update the code to test UpdatePriceRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.UpdatePriceRequest);
      });
