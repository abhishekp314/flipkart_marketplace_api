...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarkOrderItemShipped', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.MarkOrderItemShipped();
      });

      it('should create an instance of MarkOrderItemShipped', function() {
        // TODO: update the code to test MarkOrderItemShipped
        expect(instance).to.be.a(FlipkartMarketplaceApi.MarkOrderItemShipped);
      });
