...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReturnsActionResponseV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ReturnsActionResponseV2();
      });

      it('should create an instance of ReturnsActionResponseV2', function() {
        // TODO: update the code to test ReturnsActionResponseV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.ReturnsActionResponseV2);
      });
