...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutOrderOnHold', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.PutOrderOnHold();
      });

      it('should create an instance of PutOrderOnHold', function() {
        // TODO: update the code to test PutOrderOnHold
        expect(instance).to.be.a(FlipkartMarketplaceApi.PutOrderOnHold);
      });
