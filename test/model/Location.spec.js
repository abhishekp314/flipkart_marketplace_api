...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Location', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.Location();
      });

      it('should create an instance of Location', function() {
        // TODO: update the code to test Location
        expect(instance).to.be.a(FlipkartMarketplaceApi.Location);
      });
      ...
      it('should have the property pendingInventory (base name: "pending_inventory")', function() {
        // TODO: update the code to test the property pendingInventory
        expect(instance).to.have.property('pendingInventory');
        // expect(instance.pendingInventory).to.be(expectedValueLiteral);
      });
