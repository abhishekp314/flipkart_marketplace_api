...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DispatchLocation', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.DispatchLocation();
      });

      it('should create an instance of DispatchLocation', function() {
        // TODO: update the code to test DispatchLocation
        expect(instance).to.be.a(FlipkartMarketplaceApi.DispatchLocation);
      });
