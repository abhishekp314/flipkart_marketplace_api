...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BulkRtdActionRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.BulkRtdActionRequest();
      });

      it('should create an instance of BulkRtdActionRequest', function() {
        // TODO: update the code to test BulkRtdActionRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.BulkRtdActionRequest);
      });
