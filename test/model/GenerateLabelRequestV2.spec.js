...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GenerateLabelRequestV2', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.GenerateLabelRequestV2();
      });

      it('should create an instance of GenerateLabelRequestV2', function() {
        // TODO: update the code to test GenerateLabelRequestV2
        expect(instance).to.be.a(FlipkartMarketplaceApi.GenerateLabelRequestV2);
      });
