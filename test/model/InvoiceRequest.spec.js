...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.InvoiceRequest();
      });

      it('should create an instance of InvoiceRequest', function() {
        // TODO: update the code to test InvoiceRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.InvoiceRequest);
      });
