...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BulkRtdRequestItemStatus', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.BulkRtdRequestItemStatus();
      });

      it('should create an instance of BulkRtdRequestItemStatus', function() {
        // TODO: update the code to test BulkRtdRequestItemStatus
        expect(instance).to.be.a(FlipkartMarketplaceApi.BulkRtdRequestItemStatus);
      });
