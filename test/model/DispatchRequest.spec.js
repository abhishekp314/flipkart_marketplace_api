...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DispatchRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.DispatchRequest();
      });

      it('should create an instance of DispatchRequest', function() {
        // TODO: update the code to test DispatchRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.DispatchRequest);
      });
      ...
      it('should have the property facilityId (base name: "facilityId")', function() {
