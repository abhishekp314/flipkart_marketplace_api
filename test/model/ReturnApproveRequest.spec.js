...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReturnApproveRequest', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.ReturnApproveRequest();
      });

      it('should create an instance of ReturnApproveRequest', function() {
        // TODO: update the code to test ReturnApproveRequest
        expect(instance).to.be.a(FlipkartMarketplaceApi.ReturnApproveRequest);
      });
