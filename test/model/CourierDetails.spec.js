...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CourierDetails', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.CourierDetails();
      });

      it('should create an instance of CourierDetails', function() {
        // TODO: update the code to test CourierDetails
        expect(instance).to.be.a(FlipkartMarketplaceApi.CourierDetails);
      });
