...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InputStream', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.InputStream();
      });

      it('should create an instance of InputStream', function() {
        // TODO: update the code to test InputStream
        expect(instance).to.be.a(FlipkartMarketplaceApi.InputStream);
      });
