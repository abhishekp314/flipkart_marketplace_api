...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Params', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.Params();
      });

      it('should create an instance of Params', function() {
        // TODO: update the code to test Params
        expect(instance).to.be.a(FlipkartMarketplaceApi.Params);
      });
      ...
      it('should have the property isMps (base name: "is_mps")', function() {
