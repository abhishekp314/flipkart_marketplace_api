...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DateFilter', function() {
      beforeEach(function() {
        instance = new FlipkartMarketplaceApi.DateFilter();
      });

      it('should create an instance of DateFilter', function() {
        // TODO: update the code to test DateFilter
        expect(instance).to.be.a(FlipkartMarketplaceApi.DateFilter);
      });
