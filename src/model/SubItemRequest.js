...
/**
 * The SubItemRequest model module.
 * @module model/SubItemRequest
 * @version 3.0
 */
export class SubItemRequest {
  /**
   * Constructs a new <code>SubItemRequest</code>.
   * @alias module:model/SubItemRequest
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>SubItemRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SubItemRequest} obj Optional instance to populate.
   * @return {module:model/SubItemRequest} The populated <code>SubItemRequest</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SubItemRequest();
 ...
 */
SubItemRequest.prototype.listingId = undefined;
