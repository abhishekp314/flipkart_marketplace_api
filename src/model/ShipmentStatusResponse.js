...
/**
 * The ShipmentStatusResponse model module.
 * @module model/ShipmentStatusResponse
 * @version 3.0
 */
export class ShipmentStatusResponse {
  /**
   * Constructs a new <code>ShipmentStatusResponse</code>.
   * @alias module:model/ShipmentStatusResponse
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>ShipmentStatusResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ShipmentStatusResponse} obj Optional instance to populate.
   * @return {module:model/ShipmentStatusResponse} The populated <code>ShipmentStatusResponse</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ShipmentStatusResponse();
 ...
 */
ShipmentStatusResponse.prototype.shipments = undefined;
