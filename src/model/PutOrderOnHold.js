...
/**
 * The PutOrderOnHold model module.
 * @module model/PutOrderOnHold
 * @version 3.0
 */
export class PutOrderOnHold {
  /**
   * Constructs a new <code>PutOrderOnHold</code>.
   * @alias module:model/PutOrderOnHold
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>PutOrderOnHold</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutOrderOnHold} obj Optional instance to populate.
   * @return {module:model/PutOrderOnHold} The populated <code>PutOrderOnHold</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PutOrderOnHold();
 ...
 */
PutOrderOnHold.prototype.orderItemId = undefined;
