...
/**
 * The BulkOrderItem model module.
 * @module model/BulkOrderItem
 * @version 3.0
 */
export class BulkOrderItem {
  /**
   * Constructs a new <code>BulkOrderItem</code>.
   * @alias module:model/BulkOrderItem
   * @class
  ...
  /**
   * Constructs a <code>BulkOrderItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BulkOrderItem} obj Optional instance to populate.
   * @return {module:model/BulkOrderItem} The populated <code>BulkOrderItem</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BulkOrderItem();
 ...
 */
BulkOrderItem.prototype.orderItemId = undefined;

/**
 * @member {Number} quantity
 */
BulkOrderItem.prototype.quantity = undefined;
