...
/**
 * The PickUpDate model module.
 * @module model/PickUpDate
 * @version 3.0
 */
export class PickUpDate {
  /**
   * Constructs a new <code>PickUpDate</code>.
   * @alias module:model/PickUpDate
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>PickUpDate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PickUpDate} obj Optional instance to populate.
   * @return {module:model/PickUpDate} The populated <code>PickUpDate</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PickUpDate();
 ...
 * @member {Date} from
 */
PickUpDate.prototype.from = undefined;

/**
 * @member {Date} to
 */
PickUpDate.prototype.to = undefined;
