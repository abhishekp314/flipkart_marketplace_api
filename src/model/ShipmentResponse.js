...
/**
 * The ShipmentResponse model module.
 * @module model/ShipmentResponse
 * @version 3.0
 */
export class ShipmentResponse {
  /**
   * Constructs a new <code>ShipmentResponse</code>.
   * @alias module:model/ShipmentResponse
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>ShipmentResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ShipmentResponse} obj Optional instance to populate.
   * @return {module:model/ShipmentResponse} The populated <code>ShipmentResponse</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ShipmentResponse();
 ...
 */
ShipmentResponse.prototype.shipments = undefined;
