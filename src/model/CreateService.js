...
/**
 * The CreateService model module.
 * @module model/CreateService
 * @version 3.0
 */
export class CreateService {
  /**
   * Constructs a new <code>CreateService</code>.
   * @alias module:model/CreateService
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>CreateService</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateService} obj Optional instance to populate.
   * @return {module:model/CreateService} The populated <code>CreateService</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CreateService();
 ...
 */
CreateService.prototype.orderItemId = undefined;

/**
 * @member {String} serviceType
 */
CreateService.prototype.serviceType = undefined;
