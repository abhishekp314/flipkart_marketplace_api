...
export class DispatchLocation {
   ...
   * @class
   * @param address {module:model/DispatchAddress} 
   */
  constructor(address) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('address'))
        obj.address = DispatchAddress.constructFromObject(data['address']);
    }
    return obj;
  }
}
 ...
 */
DispatchLocation.prototype.locationId = undefined;

/**
 * @member {module:model/DispatchAddress} address
 */
DispatchLocation.prototype.address = undefined;
