...
/**
 * The BulkConfirmedItem model module.
 * @module model/BulkConfirmedItem
 * @version 3.0
 */
export class BulkConfirmedItem {
  /**
   * Constructs a new <code>BulkConfirmedItem</code>.
   * @alias module:model/BulkConfirmedItem
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>BulkConfirmedItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BulkConfirmedItem} obj Optional instance to populate.
   * @return {module:model/BulkConfirmedItem} The populated <code>BulkConfirmedItem</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BulkConfirmedItem();
 ...
 */
BulkConfirmedItem.prototype.orderItemId = undefined;

/**
 * @member {String} processingStatus
 */
BulkConfirmedItem.prototype.processingStatus = undefined;

/**
 * @member {String} errorMessage
 */
BulkConfirmedItem.prototype.errorMessage = undefined;

/**
 * @member {String} errorCode
 */
BulkConfirmedItem.prototype.errorCode = undefined;
