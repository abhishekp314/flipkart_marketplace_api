...
/**
 * The MarkOrderItemDelivered model module.
 * @module model/MarkOrderItemDelivered
 * @version 3.0
 */
export class MarkOrderItemDelivered {
  /**
   * Constructs a new <code>MarkOrderItemDelivered</code>.
   * @alias module:model/MarkOrderItemDelivered
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>MarkOrderItemDelivered</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MarkOrderItemDelivered} obj Optional instance to populate.
   * @return {module:model/MarkOrderItemDelivered} The populated <code>MarkOrderItemDelivered</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new MarkOrderItemDelivered();
 ...
 */
MarkOrderItemDelivered.prototype.orderItemId = undefined;
