...
/**
 * The BulkConfirmItem model module.
 * @module model/BulkConfirmItem
 * @version 3.0
 */
export class BulkConfirmItem {
  /**
   * Constructs a new <code>BulkConfirmItem</code>.
   * @alias module:model/BulkConfirmItem
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>BulkConfirmItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BulkConfirmItem} obj Optional instance to populate.
   * @return {module:model/BulkConfirmItem} The populated <code>BulkConfirmItem</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BulkConfirmItem();
 ...
 */
BulkConfirmItem.prototype.orderItemId = undefined;

/**
 * @member {String} processingStatus
 */
BulkConfirmItem.prototype.processingStatus = undefined;

/**
 * @member {String} errorMessage
 */
BulkConfirmItem.prototype.errorMessage = undefined;

/**
 * @member {String} errorCode
 */
BulkConfirmItem.prototype.errorCode = undefined;
