...
/**
 * The DeliverRequest model module.
 * @module model/DeliverRequest
 * @version 3.0
 */
export class DeliverRequest {
  /**
   * Constructs a new <code>DeliverRequest</code>.
   * @alias module:model/DeliverRequest
   * @class
  ...
  /**
   * Constructs a <code>DeliverRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeliverRequest} obj Optional instance to populate.
   * @return {module:model/DeliverRequest} The populated <code>DeliverRequest</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DeliverRequest();
 ...
 */
DeliverRequest.prototype.shipmentId = undefined;

/**
 * @member {String} locationId
 */
DeliverRequest.prototype.locationId = undefined;

/**
 * @member {Date} deliveryDate
 */
DeliverRequest.prototype.deliveryDate = undefined;
